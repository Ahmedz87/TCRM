...
if old in s:
    ...
    print("ENGINE join fixed -> groups by trading_accounts.client_id")
else:
    print("ENGINE pattern not found - paste current join lines")
import py_compile
py_compile.compile(p, doraise=True); print("engine compiles OK")
