...
struct TradeRecord
  {
   ...
   char              reason;                    // order reason
   char              conv_reserv[3];            // reserved
...
enum EnTradeReason
  {
   TR_REASON_CLIENT =0,  // by client
   TR_REASON_EXPERT =1,  // by expert
   TR_REASON_DEALER =2,  // by dealer
   TR_REASON_SIGNAL =3,  // by signal
   TR_REASON_GATEWAY=4   // by gateway
  };
//+------------------------------------------------------------------+
